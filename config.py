"""
Configuration module for Pantallita 2.0
Contains all constants, configuration classes, and validation logic
"""
...
class Layout:
	...
	PROGRESS_BAR_HORIZONTAL_X = 23  # Aligned with image
	PROGRESS_BAR_HORIZONTAL_Y = 29  # Below 28px tall image + 1px gap
...
class Timing:
	...
	FORECAST_UPDATE_INTERVAL = 900  # 15 minutes - 3 cycles
	DAILY_RESET_HOUR = 3
	...
	# Socket and session cleanup intervals
	SOCKET_ERROR_RECOVERY_DELAY = 2  # Delay after socket errors
	CRITICAL_FAILURE_DELAY = 30  # Delay after critical failures
...
## Memory Management
class Memory:
	ESTIMATED_TOTAL = 2000000  # Estimated total memory in bytes
	SOCKET_CLEANUP_CYCLES = 3
	HIGH_USAGE_THRESHOLD = 70  # Trigger GC at 70% memory usage
...
class Paths:
	...
	GITHUB_SCHEDULE_FOLDER = "schedules"
	LOCAL_SCHEDULE_FILE = "/schedules/schedules.csv"
	SCHEDULE_CACHE_MARKER = "/schedules/.last_update"
...
class Strings:
	...
	TIMEZONE_DEFAULT = os.getenv("TIMEZONE")
...
class DisplayConfig:
	...
	def validate(self):
		...
		Note: Requires utils module for logging functions.
		"""
...
class ColorManager:
	...
	BASE_COLORS_8BIT = {
		...
		"GREEN": (0, 68, 0),                 # 0x004400
		"LIME": (0, 204, 0),                 # 0x00CC00
		"BLUE": (0, 51, 102),                # 0x003366
		"ORANGE": (204, 80, 0),              # 0xCC5000
		"YELLOW": (204, 140, 0),             # 0xCC8C00
		"CYAN": (0, 204, 204),               # 0x00CCCC
		"PURPLE": (102, 0, 204),             # 0x6600CC
		"PINK": (204, 64, 120),              # 0xCC4078
		"LIGHT_PINK": (204, 102, 170),       # 0xCC66AA
		"AQUA": (0, 102, 102),               # 0x006666
		"WHITE": (204, 204, 204),            # 0xCCCCCC
		"GRAY": (102, 102, 102),             # 0x666666
		"DARK_GRAY": (32, 32, 32),           # Flickers
		"BEIGE": (136, 85, 34),              # 0x885522
		"BROWN": (51, 17, 0),                # 0x331100
	}
...
def validate_configuration():
	...
	Returns True if validation passes, False if there are critical errors.
	"""
